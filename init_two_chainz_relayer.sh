...
sudo killall $BINARY_1
sudo killall $BINARY_2
sleep 2
...
./one_chain.sh $BINARY_2 $chainid1 ./data 26677 26676 6070 9100 1318
...
sleep 5
rly start demo --home $RELAYER_CONF -p events -i 5s -l 10